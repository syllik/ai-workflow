...
- Added strict `workspace.yaml` schema validation for the eight approved projects, exclusions, access/status combinations, safe paths, and hard UTF-8 budgets.
...
- Real `apply` against `~/Desktop/WORK` was not run; the implementation blocks it.
