...
- Adding a project to `workspace.yaml` is incomplete until the `syllik/syllik` `README.md` project navigation, `docs/workspace.md`, and `docs/repositories.md` are synchronized in the same task or an explicitly coupled follow-up. Omission from profile documentation requires an explicit human decision.
